    ...
    <div className="overflow-hidden h-full">
      <div className="border-b-2 dark:border-[#33383F] border-[#E0E0E0] w-full flex justify-between px-8 py-4">
        ...
        <div className="flex items-center space-x-3">
          <div className="flex dark:bg-[#1F1F1F] bg-white border dark:border-[#343A40] items-center text-black dark:text-white rounded-md py-2 px-3 text-sm cursor-pointer">
          ...
          <button className="dark:bg-[#1F1F1F] border bg-white text-black dark:text-white dark:border-[#343A40] rounded-md py-2 px-3 text-sm">
            ...
          </button>
        </div>
      </div>
      ...
      <div className="py-8 mx-8 relative flex justify-center items-center">
        <div className="h-[2px] w-full dark:bg-[#33383F] bg-[#E0E0E0]"></div> {/* Line */}
      ...
      <div className="py-8 mx-8 relative flex justify-center items-center">
        ...
        <div className="absolute inset-0 flex justify-center items-center">
          <div className="dark:bg-[#171819] bg-[#E0E0E0] text-black dark:text-white px-4 py-1 text-sm flex items-center space-x-1">
            ...
            <span className="text-blue-500">4</span> <span>replies</span>
          </div>
        </div>
      </div>
