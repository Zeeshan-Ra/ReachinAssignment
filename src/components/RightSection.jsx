...
function RightSection() {
  return (
    <div className="border-l-2 bg-white dark:bg-black dark:border-[#33383F] border-[#E0E0E0] h-full overflow-hidden px-2">
      <div className="mt-3 dark:bg-[#23272C] bg-[#ECEFF3] text-black dark:text-white rounded-lg py-2 pl-4">
        Lead Details
      </div>
      <div className="px-6 my-8 space-y-4 dark:text-white text-[#637381]">
